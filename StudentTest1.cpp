...
TEST_SUITE("Battle simulations") {
	...
	team2.add(cowboy3);
        ...
        multi_attack(2, team, team2);cout<< "here" << endl;
        CHECK_NOTHROW(team.attack(
                &team2)); cout<< "here" << endl;// The entire enemy team will be dead before every cowboy shoots, the attack should stop and not throw an exception
